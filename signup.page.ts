...
export class SignupPage implements OnInit {
  ...
  path = 'http://aliyun.chanyoo.net/sendsms';  // 短信发送接口
  ...
  onSendSMS() {
    ...
    const httpOptions = {headers: new HttpHeaders({
      ...
      'Authorization': 'APPCODE 45fb5bdb080c4f0cbb91856c848638f9'})
    };
    // this.http.post(this.path, sbody, httpOptions)
    this.path = this.path + '?content=您正在注册生意专家，验证码为：' + tmp_code + '&mobile=' + this.signup.phone;
    // 此接口最好用get请求
